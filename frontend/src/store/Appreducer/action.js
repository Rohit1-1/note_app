...
import { ADD_NOTE_FAILURE, ADD_NOTE_REQUEST, ADD_NOTE_SUCCESS, DELETE_NOTE_FAILURE, DELETE_NOTE_REQUEST, DELETE_NOTE_SUCCESS, GET_NOTE_FAILURE, GET_NOTE_REQUEST, GET_NOTE_SUCCESS, UPDATE_NOTE_FAILURE, UPDATE_NOTE_REQUEST, UPDATE_NOTE_SUCCESS } from "./actionType";
...
export const addNote=(payload)=>(dispatch)=>{
    try {
        ...
        return axios.post(`${url}/notes`,payload,{headers:{
...
export const getNotes=()=>(dispatch)=>{
    try {
        ...
        const token=getData("token") || null
        return axios.get(`${url}/notes`,{headers:{
            authorization: `Bearer ${token}`
        }}).then((res)=>{
            console.log(res);
...
export const updateNotes=(id,payload)=>(dispatch)=>{
    try {
        ...
        const token=getData("token") || null
        return axios.patch(`${url}/notes/${id}`,payload,{headers:{
            authorization: `Bearer ${token}`
        }}).then((res)=>{
            console.log(res)
...
export const deleteNotes=(id)=>(dispatch)=>{
    try {
        ...
        const token=getData("token") || null
        return axios.delete(`${url}/notes/${id}`,{headers:{
            authorization: `Bearer ${token}`
        }}).then((res)=>{
